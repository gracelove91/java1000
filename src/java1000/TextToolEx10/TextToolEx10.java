		...
		btn[n++].addActionListener(new ActionListener() { // 패턴적용
			public void actionPerformed(ActionEvent ae) {
				...
				while(scan.hasNextLine()) {
					...
					//lineArr를  pattern에 맞게 StringBuffer sb에 저장합시다아아!!!!!!!!!!
					String result = MessageFormat.format(pattern, lineArr);
...
/*
 * 테스트 데이터 남궁성@1 강석윤@2 이원구@3 파티쉐@4 김창우@5
 */
