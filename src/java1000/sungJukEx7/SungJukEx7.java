...
//		System.out.println(sc.next());
		//String name, int classNo, int studentNo, int koreanScore, int mathScore, int englishScore
		while(sc.hasNextLine()) {
			...
			while(sc2.hasNext()) {
				list.add(new Student(sc2.next().trim(), sc2.nextInt(), sc2.nextInt(), sc2.nextInt(), sc2.nextInt(),sc2.nextInt()));
			}
		}
		/*
		 * 
